...
public class RpcRequestProxy implements InvocationHandler {
    ...
    public RpcRequestProxy(Class<?> targetClass,
                           RpcClientHandler channelHandler) {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        request.setClassName(targetClass.getName());
        request.setMethodName(method.getName());
        request.setParameters(args);
        request.setParameterTypes(method.getParameterTypes());

        return channelHandler.sendRequest(request);
    }
